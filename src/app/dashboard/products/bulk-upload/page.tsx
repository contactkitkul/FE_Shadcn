...
import { ArrowLeft, Upload, FileSpreadsheet, Image as ImageIcon, CheckCircle, XCircle, AlertCircle } from "lucide-react"
    ...
    try {
      ...
      const products = lines.slice(1).map((line, index) => {
        ...
        headers.forEach((header, i) => {
          ...
          if (header === 'featuresCurrentSeason' || header === 'featuresLongSleeve') {
      ...
      toast.success(`Successfully uploaded ${response.data.created || products.length} products`)
    } catch (error: any) {
  ...
  return (
    <div className="flex-1 space-y-4 p-8 pt-6">
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h2 className="text-3xl font-bold tracking-tight">Bulk Product Upload</h2>
            ...
            <Tabs defaultValue="csv">
              ...
              <TabsContent value="csv" className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-sm text-muted-foreground">
                    Name format: <code className="bg-muted px-1 py-0.5 rounded">SKU_position.jpg</code>
                    <br />
                    Example: <code className="bg-muted px-1 py-0.5 rounded">MU-HOME-23-24_1.jpg</code>
                  </p>
                </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4 text-sm">
              <div>
                ...
                <p className="text-muted-foreground">
                  First row should contain column headers. Each subsequent row represents a product.
                </p>
              </div>
              <div>
                <h4 className="font-semibold mb-2">Image Naming</h4>
                <p className="text-muted-foreground">
                  Images should be named as <code className="bg-muted px-1 py-0.5 rounded">SKU_position</code>
